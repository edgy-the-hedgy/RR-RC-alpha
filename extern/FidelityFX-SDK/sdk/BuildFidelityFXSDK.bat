...
cd build
cmake -A x64 .. -DFFX_API_CUSTOM=OFF -DFFX_API_VK=OFF -DFFX_API_DX12=ON -DFFX_ALL=OFF -DFFX_ALL=OFF -DFFX_API_DX11=ON -DFFX_FSR=ON -DFFX_FSR1=ON -DFFX_FSR2=ON -DFFX_AUTO_COMPILE_SHADERS=1 %*
