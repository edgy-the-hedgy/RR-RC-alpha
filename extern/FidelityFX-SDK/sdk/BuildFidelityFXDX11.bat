...
cd build
cmake -A x64 .. -DFFX_API_CUSTOM=OFF -DFFX_API_VK=OFF -DFFX_API_DX12=OFF -DFFX_ALL=OFF -DFFX_API_DX11=ON -DFFX_FSR=ON -DFFX_FSR1=OFF -DFFX_FSR2=OFF -DFFX_FI=OFF -DFFX_OF=OFF -DFFX_AUTO_COMPILE_SHADERS=1 %*
