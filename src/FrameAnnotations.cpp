...
namespace FrameAnnotations
{
	...
	struct BSImagespaceShader_Render
	{
		static void thunk(void* imageSpaceShader, RE::BSTriShape* shape, RE::ImageSpaceEffectParam* param)
		{
			...
			if constexpr (EffectType == RE::ImageSpaceManager::ISReflectionsRayTracing)
				globals::features::dynamicCubemaps.BeginReflectionRayRegenerationCapture();
			else if constexpr (EffectType == RE::ImageSpaceManager::ISApplyReflections)
				globals::features::dynamicCubemaps.BeginReflectionRayRegenerationApply();

			func(imageSpaceShader, shape, param);

			if constexpr (EffectType == RE::ImageSpaceManager::ISReflectionsRayTracing)
				globals::features::dynamicCubemaps.EndReflectionRayRegenerationCapture();
			else if constexpr (EffectType == RE::ImageSpaceManager::ISApplyReflections)
				globals::features::dynamicCubemaps.EndReflectionRayRegenerationApply();
