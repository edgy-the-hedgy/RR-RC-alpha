...
public:
	...
	WrappedResource(D3D11_BUFFER_DESC a_bufferDesc, ID3D11Device5* a_d3d11Device, ID3D12Device* a_d3d12Device, const std::string& a_name = {});
	~WrappedResource();

	ID3D11Texture2D* resource11 = nullptr;
	ID3D11Buffer* buffer11 = nullptr;
