...
void SetRadianceCacheTrainingParameters(float a_learningRate, float a_weightSmoothing)
{
    ...
    bool IsRadianceCacheContextActive() const { return radianceCacheContext != nullptr; }
    uint32_t GetRadianceCacheInferenceCapacity() const { return radianceCacheInferenceCapacity; }
    uint32_t GetRadianceCacheTrainingCapacity() const { return radianceCacheTrainingCapacity; }
