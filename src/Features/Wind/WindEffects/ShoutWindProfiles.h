...
namespace ShoutWindProfiles
{
	...
	/** Generic dragon shout values; currently tuned the same as Fire Breath. */
	inline constexpr const std::array<DirectionalProfile, 3>& kGenericDragonShoutProfiles = kFireBreathProfiles;
}
