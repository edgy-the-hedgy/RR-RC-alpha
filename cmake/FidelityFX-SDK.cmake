...
# Keep FidelityFX static archives inside the active build tree.
# The vendored SDK otherwise writes them to ${CMAKE_HOME_DIRECTORY}/bin/ffx_sdk,
# causing separate presets/configurations to share generated archives.
foreach(
  _ffx_target
